    ...
    <aside class="space-y-4 lg:sticky lg:top-4 lg:self-start" aria-label="Live build report">
        ...
        <section class="panel">
            ...
            <div class="mt-4 grid grid-cols-3 gap-2 text-xs">
                <div><h3 class="font-semibold">Spellbook · {{ report.wizard.spellbook.length }}</h3><ul class="mt-1 space-y-1"><li v-for="item in report.wizard.spellbook" :key="item.spellbook_entry_id">{{ item.spell_name }}</li></ul></div>
